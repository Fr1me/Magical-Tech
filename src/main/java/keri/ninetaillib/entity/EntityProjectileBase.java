...
public abstract class EntityProjectileBase extends EntityArrow {
    ...
    public EntityLivingBase getShooterSynced(){
        return this.world.getPlayerEntityByName(this.dataManager.get(dataMarkerShooter));
    }
    ...
    public void onUpdate(){
        ...
        if(this.inGround){
            ...
            if(mop == null || mop.entityHit == null){
                Entity entity = null;
                List list = this.world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().contract(this.motionX, this.motionY, this.motionZ).expand(1.0D, 1.0D, 1.0D));
                double d0 = 0.0D;
    ...
    public void readEntityFromNBT(NBTTagCompound tag){
        ...
        if(this.world != null){
            this.shootingEntity = this.world.getPlayerEntityByName(tag.getString("shootingEntity"));
        }
    }
