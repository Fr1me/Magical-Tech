...
public class GuiUtils {
    ...
    private static final ResourceLocation TEXTURE_BACKGROUND = new ResourceLocation(Reference.MODID, "textures/gui/background.png");
    private static final ResourceLocation TEXTURE_ELEMENTS = new ResourceLocation(Reference.MODID, "textures/gui/elements.png");
    private static final float Z_LEVEL = 100F;
    private static final String TOOLTIP_EMPTY = TextFormatting.GRAY + TranslationUtils.translate(Reference.MODID, "tooltip", "empty");
