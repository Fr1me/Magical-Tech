...
public abstract class Color {
    ...
    public Color add(Color colour2) {
        a += colour2.a;
        r += colour2.r;
        g += colour2.g;
        b += colour2.b;
    ...
    public Color sub(Color colour2) {
    ...
    public Color multiply(Color colour2) {
    ...
    public Color interpolate(Color colour2, double d) {
