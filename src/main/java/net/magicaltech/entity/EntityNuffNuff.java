package net.magicaltech.entity;
...
public class EntityNuffNuff extends EntityMob{
    ...
    private static final DataParameter<Optional<IBlockState>> CARRIED_BLOCK = EntityDataManager.<Optional<IBlockState>>createKey(EntityNuffNuff.class, DataSerializers.OPTIONAL_BLOCK_STATE);
    private static final DataParameter<Boolean> SCREAMING = EntityDataManager.<Boolean>createKey(EntityNuffNuff.class, DataSerializers.BOOLEAN);
    private int lastCreepySound;
    private int targetChangeTime;

	public EntityNuffNuff(World worldIn) {
		super(worldIn);
	 ...
	 protected void initEntityAI()
	    {
	        ...
	        this.tasks.addTask(10, new EntityNuffNuff.AIPlaceBlock(this));
	        this.tasks.addTask(11, new EntityNuffNuff.AITakeBlock(this));
	        this.targetTasks.addTask(1, new EntityNuffNuff.AIFindPlayer(this));
	    ...
	    {
	        EntityLiving.registerFixesMob(fixer, EntityNuffNuff.class);
	    }
	    ...
	    static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
	        {
	            private final EntityNuffNuff enderman;
	            /** The player */
	            private EntityPlayer player;
	            private int aggroTime;
	            private int teleportTime;

	            public AIFindPlayer(EntityNuffNuff p_i45842_1_)
	            {
	    ...
	    static class AIPlaceBlock extends EntityAIBase
	        {
	            ...
	            public AIPlaceBlock(EntityNuffNuff entityNuffNuff)
	            {
	                this.enderman = entityNuffNuff;
	            }
	    ...
	    static class AITakeBlock extends EntityAIBase
	        {
	            ...
	            public AITakeBlock(EntityNuffNuff p_i45841_1_)
	            {
	            ...
	            public void updateTask()
	            {
	                ...
	                if (EntityNuffNuff.CARRIABLE_BLOCKS.contains(block) && flag)
	                {
