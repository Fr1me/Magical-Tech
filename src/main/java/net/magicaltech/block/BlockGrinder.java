...
public class BlockGrinder extends BlockMachineBase implements ITileEntityProvider {
	...
	public BlockGrinder(String name, float hardness, float resistance, String harvestTool, int harvestLevel) {
...
//            playerIn.openGui(MagicalTech.instance, MTGuiHandler.GRINDER, worldIn, pos.getX(), pos.getY(), pos.getZ());
//            return true;
//        }
//        else
//            return false;
