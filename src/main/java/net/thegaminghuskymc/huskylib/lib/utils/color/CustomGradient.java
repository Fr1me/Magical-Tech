package net.thegaminghuskymc.huskylib.lib.utils.color;

import java.awt.image.BufferedImage;

import net.minecraft.util.ResourceLocation;
import net.thegaminghuskymc.huskylib.lib.client.render.texture.TextureUtils;
import net.thegaminghuskymc.huskylib.lib.utils.math.MathHelper;
