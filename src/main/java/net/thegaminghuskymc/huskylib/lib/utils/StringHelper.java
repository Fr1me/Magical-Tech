package net.thegaminghuskymc.huskylib.lib.utils;
...
import net.magicaltech.network.EnumUpgradeType;
...
public final class StringHelper
{
    ...
    static String translate(String prefix, String key){
        return I18n.translateToLocal(prefix + "." + Reference.MODID + "." + key + ".name");
    }

    static String translate(String prefix, String key, String suffix){
        return I18n.translateToLocal(prefix + "." + Reference.MODID + "." + key + "." + suffix);
    }
